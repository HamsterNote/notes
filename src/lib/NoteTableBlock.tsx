...
import { handleTableCellKeyDown, tableCellId } from "./tableKeyboardNavigation"
...
const NoteTableBlock = ({ block, ctx }: NoteTableBlockProps): ReactElement => {
                ...
                >
                  {row.map((cell, colIndex) => (
                    <td
                      ...
                      className={
                        rowIndex === 0 ? "hn-note-table-header-cell" : undefined
                      }
                    ...
                    >
                      ...
                      {rowIndex > 0 && (
                        <button
                          ...
                          aria-label="在此处添加行"
                          onClick={(event) => openRowEdgeMenu(event, rowIndex)}
                        >
                          +
                        </button>
                      )}
